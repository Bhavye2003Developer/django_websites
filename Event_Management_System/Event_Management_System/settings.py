...
SECRET_KEY = 'django-insecure-o%%3#(f%1&26*53sq*a3mb3)0(qpxk(-8y6tvd7lpkch!1lc9j'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media/')  # Absolute filesystem path to the directory where media files will be stored